...
void mmu_load_to_nozzle()
{
    ...
    current_position[E_AXIS] += 2.0f; //Hemera Mod
	}
	else
	{
    ...
    float feedrate = 562;
    //float feedrate = 400;      //Hemera Mod
	plan_buffer_line_curposXYZE(feedrate / 60);
    st_synchronize();
  //current_position[E_AXIS] += 14.4f;    //Hemera Mod
  current_position[E_AXIS] += 6.25f;      //Hemera Mod
	feedrate = 871;
  //feedrate = 400;                          //Hemera Mod
	plan_buffer_line_curposXYZE(feedrate / 60);
    st_synchronize();
  //current_position[E_AXIS] += 36.0f;     //Hemera Mod
  current_position[E_AXIS] += 12.5f;       //Hemera Mod
  feedrate = 1393;
  //feedrate = 700;                          //Hemera Mod
	plan_buffer_line_curposXYZE(feedrate / 60);
    st_synchronize();
  //current_position[E_AXIS] += 14.4f;    //Hemera Mod
  current_position[E_AXIS] += 6.25f;      //Hemera Mod
...
//{
//  {1.0,   1000.0/60},    //Hemera Mod
//  {1.0,   1500.0/60},    //Hemera Mod
//  {2.0,   2000.0/60},    //Hemera Mod
//  {1.5,   3000.0/60},    //Hemera Mod
//  {2.5,   4000.0/60},    //Hemera Mod
//  {-15.0, 5000.0/60},    //Hemera Mod
//  {-14.0, 1200.0/60},    //Hemera Mod
//  {-6.0,   600.0/60},    //Hemera Mod
//  {10.0,   700.0/60},    //Hemera Mod
//  {-10.0,  400.0/60},    //Hemera Mod
//  {-50.0, 2000.0/60},    //Hemera Mod
{
    {1.0,   1000.0/60},    //Hemera Mod
    {1.0,   1500.0/60},    //Hemera Mod
    {2.0,   2000.0/60},    //Hemera Mod
    {1.5,   3000.0/60},    //Hemera Mod
    {2.5,   4000.0/60},    //Hemera Mod
    {-7.5,  5000.0/60},    //Hemera Mod
    {-7.0,  1200.0/60},    //Hemera Mod
    {-6.0,   600.0/60},    //Hemera Mod
    {5,      700.0/60},    //Hemera Mod
    {-5,     400.0/60},    //Hemera Mod
    {-50.0, 2000.0/60},    //Hemera Mod
};
...
{ //unload just current filament for multimaterial printers
	...
	if (degHotend0() > EXTRUDE_MINTEMP)
	{
		...
		max_feedrate[E_AXIS] = 80;
    //current_position[E_AXIS] -= (bowden_length[mmu_extruder] + 60 + FIL_LOAD_LENGTH) / 2; //(mod for Hemera)
    current_position[E_AXIS] -= (bowden_length[mmu_extruder] + 23 + FIL_LOAD_LENGTH) / 2;               //(mod for Hemera)
...
{
    //current_position[E_AXIS] += 60;   //(Mod for Hemera)
    current_position[E_AXIS] += 25;   //(Mod for Hemera)
    plan_buffer_line_curposXYZE(MMU_LOAD_FEEDRATE);
    //current_position[E_AXIS] -= 52;   //(Mod for Hemera)
    current_position[E_AXIS] -= 5;   //(Mod for Hemera)
    plan_buffer_line_curposXYZE(MMU_LOAD_FEEDRATE);
    st_synchronize();
