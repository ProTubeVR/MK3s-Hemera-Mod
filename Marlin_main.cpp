...
//int bowden_length[4] = {385, 385, 385, 385}; //Hemera Mod
int bowden_length[4] = {415, 415, 415, 415};  //Hemera Mod
...
void gcode_M701()
{
	...
	else
	{
		...
		//current_position[E_AXIS] += 40; //hemera Mod
    current_position[E_AXIS] += 20;   //hemera Mod
		plan_buffer_line_curposXYZE(400 / 60); //fast sequence
		st_synchronize();

        raise_z_above(MIN_Z_FOR_LOAD, false);
		//current_position[E_AXIS] += 30; //hemera Mod
    current_position[E_AXIS] += 13;   //hemera Mod
		plan_buffer_line_curposXYZE(400 / 60); //fast sequence
...
void M600_load_filament_movements()
{
  ...
  //current_position[E_AXIS] += FIL_LOAD_LENGTH - 60;     //(mod for Hemera)
  current_position[E_AXIS] += FIL_LOAD_LENGTH - 23;     //(mod for Hemera)
  plan_buffer_line_curposXYZE(1400, active_extruder);
  //current_position[E_AXIS] += 40;                     //(mod for Hemera)
  current_position[E_AXIS] += 20;                       //(mod for Hemera)
  plan_buffer_line_curposXYZE(400, active_extruder);
  //current_position[E_AXIS] += 10;                       //(mod for Hemera)
...
//#define FIL_LOAD_LENGTH 60   //(mod for Hemera)
#define FIL_LOAD_LENGTH 23    //(mod for Hemera)
